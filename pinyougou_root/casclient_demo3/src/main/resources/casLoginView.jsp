            ...
            <div class="loginform">
                ...
                <div class="tab-content tab-wraped">
                    ...
                    <div id="profile" class="tab-pane  active">
                        <form:form class="sui-form" method="post" id="fm1" commandName="${commandName}"
                                   htmlEscape="true">

                            <div class="input-prepend"><span class="add-on loginname"></span>
                                    <%--  <input id="prependedInput1" type="text" placeholder="邮箱/用户名/手机号"
                                             class="span2 input-xfat">--%>
                                <form:input placeholder="邮箱/用户名/手机号"
                                            class="span2 input-xfat" id="username" size="25"
                                            tabindex="1" accesskey="${userNameAccessKey}" path="username"
                                            autocomplete="off" htmlEscape="true"/>

                            </div>
                            <div class="input-prepend"><span class="add-on loginpwd"></span>
                                    <%-- <input id="prependedInput2" type="password" placeholder="请输入密码"
                                            class="span2 input-xfat">--%>
                            ...
                            <div class="setting">
                                ...
                                <span class="forget" style="color: red;">忘记密码？</span>
                            </div>
                            <div class="logined">
                                ...
                                <input class="sui-btn btn-block btn-xlarge btn-danger" name="submit" accesskey="l"
                                       value="登&nbsp;&nbsp;录" tabindex="4" type="submit"/>
                            </div>
                            </form>
                        </form:form>
