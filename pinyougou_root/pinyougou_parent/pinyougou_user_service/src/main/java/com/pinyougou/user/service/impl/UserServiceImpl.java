...
public class UserServiceImpl implements UserService {
    ...
    public void createSmsCode(String phone) {
        String code = RandomUtils.nextInt(100000, 1000000) + "";
        System.out.println(code);
        redisTemplate.boundValueOps("code:" + phone).set(code);
        redisTemplate.expire("code" + phone, 300, TimeUnit.SECONDS);
    ...
    public boolean checkSmsCode(String phone, String code) {
        String sysCode = redisTemplate.boundValueOps("code:" + phone).get().toString();
        if (sysCode == null) {
            return false;
        }
